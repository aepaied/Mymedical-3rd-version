          ...
          Column(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  priceWidget(double.parse(widget.productModel.discountPrice.toString()), fontSize: 28, textColor: appColorPrimary),
                  8.width,
                  priceWidget(double.parse(widget.productModel.price.toString()), applyStrike: true, fontSize: 18),
                  16.width,
