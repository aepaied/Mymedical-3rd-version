...
import 'package:my_medical_app/defaultTheme/model/CategoryModel.dart';
      ...
      return ListView.builder(
        ...
        itemBuilder: (_, index) {
          ...
          return Container(
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        priceWidget(double.parse(data.discountPrice.toString())),
                        8.width,
                        priceWidget(double.parse(data.price.toString()), applyStrike: true),
                      ],
                    ),
                  ],
                ).paddingAll(8),
            ...
            int index = await ProductDetailsPage(productModel: data).launch(context);
