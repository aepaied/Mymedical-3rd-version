            ...
            children: <Widget>[
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(image: AssetImage(widget.product.thumbnail_image), fit: BoxFit.cover),
                ),
              ),
              SizedBox(width: 15),
              Flexible(
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(width: 8),
                    Text(widget.product.base_price.toString(), style: Theme.of(context).textTheme.headline4),
                  ],
                ),
              )
            ],
