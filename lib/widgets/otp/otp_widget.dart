...
class OTPCustomDialog extends StatelessWidget {
  final bool isRegister;
  final String email;
  final String mobile;

  OTPCustomDialog({@required this.isRegister, this.email, this.mobile});
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            otpC.smsSent.value
                ? Text("${translator.translate('code_sent')}",
            ...
            otpC.smsSent.value
                ...
                : Container(),
            Text(
                "${translator.translate("sms_sent")} ${otpC.registerMobileNumber}")
          ],
        ),
      ),
    ),
