...
import 'package:my_medical_app/widgets/search/searchPresenter.dart';
                      ...
                      onTap: () {
                        ...
                        if (searchController.text.length > 0) {
                          ...
                          Navigator.push(context, MaterialPageRoute(
                            ...
                            return ProductsScreen(
                              search: true,
                              widgetSearchText: searchController.text,
                              widgetSortByFilter: sortBy,
                            );
                          }));
                        }
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            onTap: () {
                              SearchHistoryHelpers()
                                  .saveSearchHistory(searchController.text);
                              Get.to(() => ShProductDetail(
                                  is_ad: false,
                                  productID: searchData[index].id));
                    ...
                    Visibility(
                      ...
                      child: Center(
                        child: Opacity(
                          opacity: 0.4,
                          child: Text(
                            "${translator.translate("there_are_no")}" +
                                " " +
