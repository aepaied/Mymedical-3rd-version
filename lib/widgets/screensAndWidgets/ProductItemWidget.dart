                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      */ /*SizedBox(height: 7),
                  Text(
                    '${product.sales} '+translator.translate('available'),
                    style: Theme.of(context).textTheme.bodyText2,
                    overflow: TextOverflow.ellipsis,
                  ),
    ...
    return Stack(
      ...
      children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        '${widget.product.base_discounted_price} ' + "LE",
                        style: Theme
                            .of(context)
                            .textTheme
                            .bodyText2,
        ...
        GestureDetector(
            ...
            child: Container(
              margin: EdgeInsets.only(top: MediaQuery.of(context).size.height * 16.5),
              padding: EdgeInsets.only(
